...
using WMS.Core.Infrastructure.Mapper;

namespace WMS.Core.Infrastructure
{
    public class WMSEngine:IEngine
    {
        #region Properties
        ...
        /// <summary>
        /// Register and configuration AutoMapper
        /// </summary>
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IWMSStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IWMSStartup)Activator.CreateInstance(startup))
