...
using WMS.Core;
using WMS.Data.Mapping;
using System.Reflection;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Query;
namespace WMS.Data
{
    public partial class WMSObjectContext : IdentityDbContext<ApplicationUser>, IDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var typeConfigurations = Assembly.GetExecutingAssembly().GetTypes().Where(type =>
                (type.BaseType?.IsGenericType ?? false)
                    && (type.BaseType.GetGenericTypeDefinition() == typeof(WMSEntityTypeConfiguration<>)
                        || type.BaseType.GetGenericTypeDefinition() == typeof(WMSQueryTypeConfiguration<>)));
        ...
        {
            var query = Set<TEntity>().FromSqlRaw(CreateSqlWithParameters(sql, parameters), parameters);
            return query;
